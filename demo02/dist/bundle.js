...
var MyComponent = /** @class */ (function (_super) {
    ...
    MyComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1_vue_class_component__["a" /* default */])({
            template: '<button @click="onClick">Click!</button>'
        })
    ], MyComponent);
    return MyComponent;
}(__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]));
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* unused harmony export createDecorator */
...
function mixins() {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].extend({ mixins: Ctors });
}
function isPrimitive(value) {
...
function collectDataFromConstructor(vm, Component) {
    ...
    if (process.env.NODE_ENV !== 'production') {
        if (!(Component.prototype instanceof __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]) && Object.keys(plainData).length > 0) {
...
function componentFactory(Component, options) {
    ...
    var Super = superProto instanceof __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]
